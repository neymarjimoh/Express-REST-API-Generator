...
var objId1 = db.Books._mongoose.Types.ObjectId();
describe('Books controller', function(){
    ...
    describe('Find', function(){
        it('should build projection', function(done){
            ...
            var project = books.buildProjection(projection);
